...
const members = [
    {
        name: 'Frank Verhagen',
        role: 'Founder - CEO',
        avatar: '/frank.JPG', // ✅ Nu verwijst dit naar de public map
        link: '#',
    },
    {
        name: 'Luke Zwartbol',
        role: 'Co-Founder - CTO',
        avatar: '/luke.JPG', // ✅ Nu verwijst dit naar de public map
        link: '#',
    },
    {
            ...
            <div className="mx-auto max-w-5xl border-t px-6">
                ...
                <div className="mt-12 gap-4 sm:grid sm:grid-cols-2 md:mt-24">
                    <div className="sm:w-2/5">
                        <h2 className="text-3xl font-bold sm:text-4xl">Onze Droom</h2>
                    </div>
                    <div className="mt-6 sm:mt-0">
                        <p>Ons doel is het bouwen van een super hecht team dat samen de zelfde visie deelt. Namelijk makelaars helpen met de meest slimme en innovatieve AI-oplossingen!</p>
                    </div>
                </div>
